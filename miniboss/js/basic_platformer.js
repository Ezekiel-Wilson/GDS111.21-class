...
var player;
	...
	glider = new GameObject({width:24, height:50,x:canvas.width-600, y:200, color:"green"})
...
function animate()
{
	...
	if(player.canJump == true && glider.y==15000)
	{
		gravity= 1
	...
	if(player.hitTestObject(glider) && player.canJump == false)
	{
		glider.y=15000;
		gravity=gravity/10;
	}
	if(glider.y==15000 && player.canJump == false && player.vy >=5)
	{
		gravity=.2;
	}
